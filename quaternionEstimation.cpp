...
void qEstimator::getQuaternion(float* _q)
{
	_q[0] = q[0];
	_q[1] = q[1];
	_q[2] = q[2];
...
void qEstimator::toEulerAngle(double* eulers)
{
...
void qEstimator::MadgwickUpdate(float ax, float ay, float az, float gx, float gy, float gz, float mx, float my, float mz)
{
